...
<form class="text-center border border-light p-5">
    ...
    <!-- Sign in button -->
    <button class="btn btn-info btn-block my-4" type="submit"style="color:white; background-color:rgba(255, 204, 102,0.50)
; border-color:rgb(255, 221, 153,0.15);"><strong>{{ __('Login') }}</strong></button>
